...
public class LogFilter implements Filter {
    ...
    public Response filter(FilterableRequestSpecification requestSpec,
        ...
        RequestPrinter.print(requestSpec, requestSpec.getMethod(),
                requestSpec.getURI(), LogDetail.ALL, requestSpec.getConfig()
                        .getLogConfig().blacklistedHeaders(), stream, true);
        ...
        ResponsePrinter.print(response, response.body(), stream,
                LogDetail.ALL, true, requestSpec.getConfig()
                        .getLogConfig().blacklistedHeaders());
